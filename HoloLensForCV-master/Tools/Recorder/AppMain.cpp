...
namespace Recorder
{
    ...
    {
        StartHoloLensMediaFrameSourceGroup(holographicSpace);
    ...
    void AppMain::LoadAppState()
    {
        ...
        StartHoloLensMediaFrameSourceGroup(Windows::Graphics::Holographic::HolographicSpace::CreateForCoreWindow(window));
    }
    ...
    Platform::String^ AppMain::stringToPlatformString(std::string inputString)
    {
    ...
    void AppMain::StartHoloLensMediaFrameSourceGroup(Windows::Graphics::Holographic::HolographicSpace^ holospace)
    {
        REQUIRES(
