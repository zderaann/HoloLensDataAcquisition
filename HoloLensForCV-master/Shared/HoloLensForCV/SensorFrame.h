...
namespace HoloLensForCV
{
    ...
    public:
        ...
        property Windows::Foundation::Numerics::quaternion orientation;

        property Windows::Perception::Spatial::SpatialLocator^ locator;
        property Windows::Perception::Spatial::SpatialCoordinateSystem^ coordinateSystem;
